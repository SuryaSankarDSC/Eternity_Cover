        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center p-5">
            ...
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Secure Your Health, Car, and Home
              <br className="hidden lg:inline-block" />
              for a Worry-Free Future
            </h1>
            <p className="mb-8 leading-relaxed">
              Comprehensive plans for every stage of your life.
            </p>
            <div className="flex justify-center relative w-180 p-7 px-20 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
              <form>
                ...
                <button
                  type="submit"
                  className="text-white bg-[#f97316] hover:bg-[#fb923c] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                >
                  Get a quote &gt;
                </button>
              </form>
